                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand home" href="index.jsp">
                                ...
                                <img src="img/logo-small.png" alt="Universal logo" class="visible-xs visible-sm"><span class="sr-only">Mincit Eventos - Calendario</span>
                            </a>
                        ...
                        <div class="col-md-12">
                            <div class="month"> 
                                <ul>
                                    <li class="prev">&#10094;</li>
                                    <li class="next">&#10095;</li>
                                    <li class="text-center"> August<br><span>2016</span></li>
                                </ul>
                            </div>
