<%-- 
    Document   : 11.1.respuestaCuestionario
    Created on : 30-nov-2016, 16:21:13
    Author     : ALEJANDRA
--%>
                    ...
                    <section id="content">
                        <section class="vbox">
                            ...
                            <section class="scrollable">
                                <section class="hbox stretch">
                                    <h3>Resultado de la encuesta</h3>
                                    <%
                                    String resultado = (String) session.getAttribute("resultado_emprendedor");
